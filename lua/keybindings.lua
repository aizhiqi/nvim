...
pluginKeys.mapLSP = function(mapbuf)
  ...
  if G.lsp_ui then
    ...
    key_map("n", "d", "<cmd>Lspsaga goto_definition<CR>", "definition")
    key_map("n", "h", "<cmd>Lspsaga hover_doc<CR>", "hover")
    key_map("n", "r", "<cmd>Lspsaga finder<CR>", "reference")
    key_map("n", "]", "<cmd>Lspsaga diagnostic_jump_next<CR>", "diagnostic next")
    key_map("n", "[", "<cmd>Lspsaga diagnostic_jump_prev<CR>", "diagnostic prev")
    key_map("n", "i", "<cmd>Lspsaga incoming_calls<CR>", "diagnostic prev")
    key_map("n", "o", "<cmd>Lspsaga outgoing_calls<CR>", "diagnostic prev")
    key_map("n", "s", "<cmd>SymbolsOutline<CR>", "outline")
    key_map('n', 'D', '<cmd>Trouble lsp_definitions<CR>', "lsp_definitions")
    key_map("n", "R", "<cmd>Trouble lsp_references<CR>", "lsp_references")
    ...
    key_map("n", "i", "<cmd>lua vim.lsp.incoming_calls()<CR>", "diagnostic prev")
    key_map("n", "o", "<cmd>lua vim.lsp.outgoing_calls()<CR>", "diagnostic prev")
    key_map("n", "s", "<cmd>SymbolsOutline<CR>", "outline")
