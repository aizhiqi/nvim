...
pluginKeys.nvimTreeList = function (bufnr)
  ...
  key_map('n', 'vs',    api.node.open.vertical,                '<cmd>lua require("nvim-tree.api").node.open.vertical()<CR>',               'Open: Vertical Split')
  key_map('n', 'sp',    api.node.open.horizontal,              '<cmd>lua require("nvim-tree.api").node.open.horizontal()<CR>',             'Open: Horizontal Split')
