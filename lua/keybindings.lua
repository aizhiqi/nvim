...
pluginKeys.mapLSP = function(mapbuf)
  ...
  if G.lsp_ui then
    -- rename
    key_map("n", "n", "<cmd>LspUI rename<CR>", "rename")
    key_map("n", "a", "<cmd>LspUI code_action<CR>", "code_action")
    key_map("n", "d", "<cmd>LspUI definition<CR>", "definition")
    key_map("n", "h", "<cmd>LspUI hover<CR>", "hover")
    key_map("n", "r", "<cmd>LspUI reference<CR>", "reference")
    key_map("n", "]", "<cmd>LspUI diagnostic next<CR>", "diagnostic next")
    key_map("n", "[", "<cmd>LspUI diagnostic prev<CR>", "diagnostic prev")
